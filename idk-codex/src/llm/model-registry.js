...
const BASE_MODEL_OPTIONS = [
  ...
  },
  {
    ...
    description: 'GPT-OSS 20B — free, reliable, supports function calling',
  ...
  },
  {
    ...
    speedLabel: '🧠',
    bestFor: ['code', 'analysis', 'general'],
    description: 'GPT-OSS 120B — free, strong general agent, larger context',
    contextWindow: 131000,
    maxOutputTokens: 8192
  },
  {
    ...
    description: 'DeepSeek V3 — strong reasoning, paid (~$0.01/call)',
    contextWindow: 64000,
    maxOutputTokens: 8192
  },
  {

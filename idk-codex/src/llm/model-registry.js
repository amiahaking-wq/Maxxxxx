...
const BASE_MODEL_OPTIONS = [
  ...
  },
  {
    ...
    speed: 'medium',
    speedLabel: '🧠',
    bestFor: ['reasoning', 'code', 'analysis'],
    description: 'DeepSeek V3 via OpenRouter — strong reasoning, paid (~$0.01/call)',
    contextWindow: 64000,
    maxOutputTokens: 8192
  },
  {
    ...
    speed: 'medium',
    speedLabel: '⚡',
    bestFor: ['code', 'chat', 'multilingual'],
    description: 'Qwen 2.5 Coder 32B via OpenRouter — free, strong coding, supports function calling',
    contextWindow: 128000,
    maxOutputTokens: 8192
  },
  {
    ...
    speed: 'fast',
    speedLabel: '⚡',
    bestFor: ['code', 'chat', 'function-calling'],
    description: 'Mistral Small 3.1 24B via OpenRouter — free, excellent function calling support',
    contextWindow: 128000,
    maxOutputTokens: 8192
  },
  {
